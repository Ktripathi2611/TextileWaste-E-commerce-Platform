        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-4">
              EcoFashion is dedicated to sustainable and environmentally friendly
              fashion. We believe in reducing waste and creating beautiful products
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                ...
                <span className="text-gray-600">support@ecofashion.com</span>
              </li>
              <li className="flex items-start">
                <svg
                  className="h-5 w-5 text-gray-500 mr-2 mt-0.5"
              ...
              <li className="flex items-start">
                ...
                <span className="text-gray-600">
                  123 Eco Street, Green City, EA 12345
                </span>
              </li>
            </ul>
          </div>
